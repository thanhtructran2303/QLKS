...
from hotel import app, db, dao
from hotel.models import LoaiPhong, Phong
from flask_login import logout_user, current_user
from flask import redirect, request

from hotel.models import UserRoleEnum
...
admin = Admin(app=app, name='KHÁCH SẠN TUPU', template_mode='bootstrap4', index_view=MyAdminIndex())
